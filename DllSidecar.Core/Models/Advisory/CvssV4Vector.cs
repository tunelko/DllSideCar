...
/// <summary>CVSS 4.0 Base metrics. Spec: https://www.first.org/cvss/v4.0/specification-document</summary>
public class CvssV4Vector
{
    ...
    /// <summary>Canonical v4.0 vector string, e.g. "CVSS:4.0/AV:L/AC:L/AT:N/PR:L/UI:N/VC:H/VI:H/VA:H/SC:N/SI:N/SA:N".</summary>
